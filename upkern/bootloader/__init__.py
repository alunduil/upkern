...
"""Defines the bootlaoder base module and factory."""
...
from upkern.bootlaoder.bootloaders import Grub
...
def BootLoader(*args, **kargs):
    ...
    bootloaders = [
            split_cpv(bootloader)[1] + Package(bootloader).environment(
                "SLOT") for bootloader in bootloaders
            ]
